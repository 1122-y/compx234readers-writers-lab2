...
class ReadersWritersMonitor:
    ...
    def start_read(self, reader_id: int) -> None:
        ...
        with self.condition:
            ...
            while self.active_writer>0:
                print(f"Read{reader_id}is waiting to read")
                self.condition.wait()
            self.active_readers+=1
            print(f"Read{reader_id}starts raeding.Active readers={self.active_readers}")
    ...
    def start_write(self, writer_id: int) -> None:
        ...
        with self.condition:
            ...
            while self.waiting_writers>=self.active_readers:
